...
<section class="content-header">
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-6">
				<p class="text-uppercase">Sertifikasi Interasional</p>				
			</div>
			<div class="col-sm-6">
		...
		<div class="col-md-6">
			<div class="card card-success card-outline">
				<div class="card-body box-profile">
					...
					echo form_open_multipart(base_url('admin/si/edit/'. $dokumen['id']), '' )
                    ?>
...
<script>
	...
	$("#si .sub-<?=$dokumen['id_kategori_dokumen']; ?> a.nav-link").addClass('active');
</script> 