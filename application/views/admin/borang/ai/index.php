...
<section class="content-header">
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-6">
				<p class="text-uppercase">Akreditasi Internasional</p>				
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?= base_url() ?>admin/dashboard"><i class="nav-icon fas fa-home"></i></a></li>
					<li class="breadcrumb-item">Akreditasi Internasional</li>
		...
		<div class="row">
			...
			<div class="col-sm-2 text-right">
				<select id="pilih_dokumen" class="form-control">
					...
					<?php foreach (menu_category('ai') as $row) { ?>
					<option value="<?=base_url('admin/ai/dokumen/'.$row['id']); ?>">
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-sm btn-warning"
										href="<?= base_url('admin/ai/edit/'.$dokumen['id']) ?>"><i
...
<script type="text/javascript">
	...
	$("#ai").addClass('menu-open');
	$("#ai .sub-<?=$kategori?> a.nav-link").addClass('active');
